...
data class FilterDto(
    ...
    @param:Json(name = "tagIDs") val tagIDs: List<Int> = emptyList(),
    @param:Json(name = "objectIDs") val objectIDs: List<Int> = emptyList(),
    @param:Json(name = "brands") val brands: List<String> = emptyList(),
